...
import 'package:league_for_enjoy/new_club_page.dart';
import 'package:league_for_enjoy/participant_page.dart';
import 'package:league_for_enjoy/search_page.dart';
import 'choicesP.dart';
import 'customListTilesP.dart';

void main() {
  runApp(const GeneralOverviewPageParticipant());
}

class GeneralOverviewPageParticipant extends StatelessWidget {
  const GeneralOverviewPageParticipant({Key? key}) : super(key: key);
